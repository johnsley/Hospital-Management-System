...
<br />
	<div id="print">
		...
		<center>	
			...
			<?php
				$query = $conn->query("SELECT * FROM `rehabreps` WHERE `service_id`='$_GET[id]' ") or die(mysqli_error());
			...
			<center>
				...
				<tr>
					<td colspan="5"><br>
						<p><b>Chief Complaint: <?php echo $fetch['ccomp']; ?></b></p>
						<p><b>Patient History: <?php echo $fetch['phist']; ?></b></p>
						<p><b>Examination: <?php echo $fetch['exam']; ?></b></p>
						<p><b>Findings: <?php echo $fetch['find']; ?></b></p>
						<p><b>Impression: <?php echo $fetch['imp']; ?></b></p>
						<p><b>Treatment Given: <?php echo $fetch['tmt']; ?></b></p>
						<p><b>Conclusion: <?php echo $fetch['conc']; ?></b></p>
					</td>
				</tr>
				</table>
			</center>
