           ...
           <div class="row">
				...
				<div class = "panel panel-success">	
					<div class = "panel-heading">
						...
						<a href = "maternity.php" class = "btn btn-sm btn-info" style = "float:right; margin-top:-5px;"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
					</div>
		            ...
		            <form id = "form_dental" method = "POST" enctype = "multipart/form-data">
							...
							<br /><br />
							<div class = "form-inline">
								<button class = "btn btn-primary" name = "edit_mat"><span class = "glyphicon glyphicon-save"></span> SAVE</button>
							</div>
