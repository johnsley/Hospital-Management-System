	           ...
	           <div class="col-sm-12">
				...
				<div class = "panel panel-default">
					...
					<div class = "panel-body" style="padding: 20px">
							<div>
							  <form  method = "POST" enctype = "multipart/form-data" action="cash_report.php">		
								<div class = "form-inline">
									<span class='input-group date' id='datetimepicker'>
										<input class = "form-control" name = "fromdate" type = "text" placeholder="Select date" required = "required">
					...
					<div class = "panel panel-default">
					<div class = "panel-heading">
						<label>VIEW MONTHLY REPORT</label>
					</div>
					<div class = "panel-body" style="padding: 20px">
							<div>
							<form  method = "POST" enctype = "multipart/form-data" action="monthly_report.php">
								<div class = "form-inline">
...
<div class = "panel panel-default">
<div class = "panel-heading">
    <label>VIEW DAILY DEPARTMENTAL REPORT</label>
</div>
<div class = "panel-body" style="padding: 20px">
        <div>
        <form  method = "POST" enctype = "multipart/form-data" action="daily_dpt_report.php">
            <div class = "form-inline">
            <span class='input-group date' id='datetimepicker4'>
                <input class = "form-control" name = "dailydate" type = "text" placeholder="Select date" required = "required">
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </span>
            ...
            <span class='input-group'>
              <select class="form-control" id="dpt" name="dpt" required="required">
...
<div class = "panel panel-default">
<div class = "panel-heading">
    <label>VIEW MONTHLY DEPARTMENTAL REPORT</label>
</div>
<div class = "panel-body" style="padding: 20px">
        <div>
        <form  method = "POST" enctype = "multipart/form-data" action="monthly_dpt_report.php">
            <div class = "form-inline">
            <span class='input-group date' id='datetimepicker5'>
                <input class = "form-control" name = "mindptdate" type = "text" placeholder="From" required = "required">
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </span>
            ...
            <span class='input-group date' id='datetimepicker6'>
                <input class = "form-control" name = "maxdptdate" type = "text" placeholder="To" required = "required">
                <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </span>
