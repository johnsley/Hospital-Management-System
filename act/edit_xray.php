           ...
           <div class="row">
				...
				<div class = "panel panel-success">	
					<div class = "panel-heading">
						...
						<a href = "xray.php" class = "btn btn-info" style = "float:right; margin-top:-5px;"><span class = "glyphicon glyphicon-hand-right"></span> BACK</a>
					</div>
					<div class = "panel-body">

					<form id="regform" method="post" onkeypress="return event.keyCode!=13" enctype="multipart/form-data" action="savradio.php" >
					<?php
					...
					<?php 
						...
						echo '<tr><td style="vertical-align:top;"><label>Examination: </label></td> <td><textarea rows="4" cols="53" name="exam" id="exam">'.$ex.'</textarea></td></tr>'; 
						echo '<tr><td style="vertical-align:top;"><label>Clinical Summary: </label></td> <td><textarea rows="4" cols="53" name="summ" id="summ">'.$s.'</textarea></td></tr>';
						...
						echo '<tr><td style="vertical-align:top;"><label>Conclusion: </label></td> <td><textarea rows="4" cols="53" name="conc" id="conc">'.$c.'</textarea></td></tr>';
						echo '<input type="hidden" id="oldrec" name="oldrec" value="'.$e.'"/>';
					?>
					     <tr><td> </td></tr><br />
