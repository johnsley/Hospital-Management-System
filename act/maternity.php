 ...
 <div id="wrapper">
        ...
        <div id="page-wrapper">
           ...
           <div class="row">
				...
				<div class = "panel-body">
					<form id = "form_dental" method = "POST" enctype = "multipart/form-data">
						<div class = "col-sm-12" style="padding:0px;padding-top: 1%">
							...
							?>
							<div class="col-sm-6">
							<input name = "category" type = "hidden"  value = "maternity">
					    ...
					    <div class="col-sm-12" style="padding:0px;padding-top: 2%">
					    	<div class="col-sm-5">
								...
								<select id="item" name = "item" required = "required" style="width:100%;padding: 5px">
		                            ...
		                            <?php
										$query = $conn->query("SELECT * FROM `item` WHERE `type`='maternity' ") or die(mysqli_error());
										while($row = $query->fetch_array()){
										$item_id = $row['item_id'];
										?>
			...
			<a id = "show_itr">&nbsp;<img src="images/patient.jpg" style="width: 50px;height: 50px"> <strong>Add Maternity Charges</strong></a>
			</div>
			<div  id = "a_table" class="panel panel-default">
				<div class = "panel-body">
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
						<?php
	                        $query = $conn->query("SELECT * FROM `service` WHERE `category` = 'maternity' ORDER BY `date` DESC") or die(mysqli_error());
