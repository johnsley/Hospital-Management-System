 ...
 <div id="wrapper">
        ...
        <div id="page-wrapper">
           ...
           <div class="col-lg-12">
			...
			<div class="panel panel-warning" style="font-size:1.2em;padding: 10px">

			<ul style="text-decoration: none;list-style: none">
				<li style="padding: 10px"><a href = "service.php"><img src="../assets/sysa.png" style="width:20px;height:20px"> Items</a></li>
				<li style="padding: 10px"><a href = "user.php"><img src="../assets/set.png" style="width:20px;height:20px"> User</a></li>
                <li style="padding: 10px"><a href = "doctors.php"><img src="../assets/cons.png" style="width:20px;height:20px"> Doctors</a></li>
			</ul>
