<?php
	...
	if(ISSET($_POST['save_d'])){
		...
		echo "<script>window.location = 'view_dental_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_f'])){
		...
		echo "<script>window.location = 'view_fecalysis_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_h'])){
		...
		echo "<script>window.location = 'view_hematology_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_u'])){
		...
		echo "<script>window.location = 'view_urinalysis_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_r'])){
		...
		echo "<script>window.location = 'view_rehabilitation_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_s'])){
		...
		echo "<script>window.location = 'view_sputum_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_x'])){
		...
		echo "<script>window.location = 'view_xray_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_p'])){
		...
		echo "<script>window.location = 'view_prenatal_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_patient'])){
		...
		echo "<script>window.location = 'view_birth_record.php'</script>";
		$conn->close();
	}
	if(ISSET($_POST['save_birth'])){
		...
		echo "<script>window.location = 'view_birthing_record.php'</script>";
		$conn->close();
	}	